...
export class LoginComponent implements OnInit {
  ...
  // Image
  imgLogo = 'assets/img/logo/jan-logo.png'
  ...
  loginFormMessages = {
    'username': [
      ...
      { type: 'email', message: 'Masukkan email yang sah'}
    ],
    'password': [
  ...
  successMessage() {
    let title = 'Log masuk'
    let message = 'Berjaya!'
    this.notifyService.openToastr(message, title)
  }

  failedMessage(){
    let title = 'Log masuk'
    let message = 'Gagal, cuba lagi.'
    this.notifyService.openToastrHttp(message, title)
  }
